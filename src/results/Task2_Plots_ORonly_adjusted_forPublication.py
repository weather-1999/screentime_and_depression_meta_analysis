...
def create_forest_plot(df, meta_results, output_prefix):
    ...
    # Save plots
    plt.savefig(f'{output_prefix}_Forest_ORonly_adjusted_forPublication.png', dpi=300, bbox_inches='tight',
                facecolor='white', edgecolor='none')
    plt.savefig(f'{output_prefix}_Forest_ORonly_adjusted_forPublication.pdf', dpi=300, bbox_inches='tight',
                facecolor='white', edgecolor='none')
    
    print(f"Forest plot saved: {output_prefix}_Forest_ORonly_adjusted_forPublication.png")
    print(f"Forest plot saved: {output_prefix}_Forest_ORonly_adjusted_forPublication.pdf")
...
def create_funnel_plot(df, meta_results, output_prefix):
    ...
    # Save plots
    plt.savefig(f'{output_prefix}_Funnel_ORonly_adjusted_forPublication.png', dpi=300, bbox_inches='tight',
                facecolor='white', edgecolor='none')
    plt.savefig(f'{output_prefix}_Funnel_ORonly_adjusted_forPublication.pdf', dpi=300, bbox_inches='tight',
                facecolor='white', edgecolor='none')
    
    print(f"Funnel plot saved: {output_prefix}_Funnel_ORonly_adjusted_forPublication.png")
    print(f"Funnel plot saved: {output_prefix}_Funnel_ORonly_adjusted_forPublication.pdf")
...
def main():
    ...
    print("="*70)
    print(f"\nOutput files:")
    print(f"  - {output_prefix}_Forest_ORonly_adjusted_forPublication.png")
    print(f"  - {output_prefix}_Forest_ORonly_adjusted_forPublication.pdf")
    print(f"  - {output_prefix}_Funnel_ORonly_adjusted_forPublication.png")
    print(f"  - {output_prefix}_Funnel_ORonly_adjusted_forPublication.pdf")
