...
def create_forest_plot(df, meta_results, output_prefix):
    ...
    print(f"Forest plot saved: {output_prefix}_forest_plot.png/pdf")
...
def create_funnel_plot(df, meta_results, output_prefix):
    ...
    ax.text(0.02, 0.98, warning_text, transform=ax.transAxes, fontsize=9,
            style='italic', va='top', bbox=dict(boxstyle='round', facecolor='wheat', alpha=0.5))
    ...
    print(f"Funnel plot saved: {output_prefix}_funnel_plot.png/pdf")
