...
def create_forest_plot(df, meta_results, output_prefix):
    ...
    pooled_text = f"{pooled_es:.2f} [{pooled_lower:.2f}, {pooled_upper:.2f}]"
    ax.text(1.02, pooled_y, pooled_text, fontsize=9, fontweight='bold', 
    ...
    # Save plots
    plt.savefig(f'{output_prefix}_Forest_ORonly_adjusted.png', dpi=300, bbox_inches='tight',
                facecolor='white', edgecolor='none')
    plt.savefig(f'{output_prefix}_Forest_ORonly_adjusted.pdf', dpi=300, bbox_inches='tight',
                facecolor='white', edgecolor='none')
    
    print(f"Forest plot saved: {output_prefix}_Forest_ORonly_adjusted.png")
    print(f"Forest plot saved: {output_prefix}_Forest_ORonly_adjusted.pdf")
...
def create_funnel_plot(df, meta_results, output_prefix):
    ...
    # Save plots
    plt.savefig(f'{output_prefix}_Funnel_ORonly_adjusted.png', dpi=300, bbox_inches='tight',
                facecolor='white', edgecolor='none')
    plt.savefig(f'{output_prefix}_Funnel_ORonly_adjusted.pdf', dpi=300, bbox_inches='tight',
                facecolor='white', edgecolor='none')
    
    print(f"Funnel plot saved: {output_prefix}_Funnel_ORonly_adjusted.png")
    print(f"Funnel plot saved: {output_prefix}_Funnel_ORonly_adjusted.pdf")
...
def main():
    ...
    print("="*70)
    print(f"\nOutput files:")
    print(f"  - {output_prefix}_Forest_ORonly_adjusted.png")
    print(f"  - {output_prefix}_Forest_ORonly_adjusted.pdf")
    print(f"  - {output_prefix}_Funnel_ORonly_adjusted.png")
    print(f"  - {output_prefix}_Funnel_ORonly_adjusted.pdf")
