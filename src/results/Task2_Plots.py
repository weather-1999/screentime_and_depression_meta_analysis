#!/usr/bin/env python3
"""
Meta-Analysis Visualization Script
===================================
...
def create_forest_plot(df, meta_results, output_prefix):
    ...
    -----------
    df : DataFrame
        Study data with log-transformed effect sizes
    meta_results : dict
    ...
    # Title and heterogeneity statistics
    ...
    # Save plots
    plt.savefig(f'{output_prefix}_forest_plot.png', dpi=300, bbox_inches='tight',
                facecolor='white', edgecolor='none')
    plt.savefig(f'{output_prefix}_forest_plot.pdf', dpi=300, bbox_inches='tight',
                facecolor='white', edgecolor='none')
    
    print(f"Forest plot saved: {output_prefix}_forest_plot.png")
    print(f"Forest plot saved: {output_prefix}_forest_plot.pdf")
...
def create_funnel_plot(df, meta_results, output_prefix):
    ...
    Note: Exploratory only due to small number of studies (n=9).
    ...
    title = ('Funnel Plot: Screen Time and Depression Risk\n'
             '(EXPLORATORY - Small number of studies, n=9)')
    ...
    caveat_text = ("Note: This funnel plot is exploratory.\n"
                   "With only 9 studies, visual inspection for\n"
                   "publication bias has limited reliability.\n"
                   "Formal tests (e.g., Egger's) require ≥10 studies.")
    ...
    # Save plots
    plt.savefig(f'{output_prefix}_funnel_plot.png', dpi=300, bbox_inches='tight',
                facecolor='white', edgecolor='none')
    plt.savefig(f'{output_prefix}_funnel_plot.pdf', dpi=300, bbox_inches='tight',
                facecolor='white', edgecolor='none')
    
    print(f"Funnel plot saved: {output_prefix}_funnel_plot.png")
    print(f"Funnel plot saved: {output_prefix}_funnel_plot.pdf")
...
def main():
    """Main function to run the meta-analysis visualization."""
    ...
    print(f"\nOutput files:")
    print(f"  - {output_prefix}_forest_plot.png")
    print(f"  - {output_prefix}_forest_plot.pdf")
    print(f"  - {output_prefix}_funnel_plot.png")
    print(f"  - {output_prefix}_funnel_plot.pdf")
